...
public interface OfflineNumsDao extends JpaRepository<OfflineNum, String>, JpaSpecificationExecutor<OfflineNum> {
    ...
    /**
     * 故方法名思议，以receiver做为ClientA进行ack，ClientA即作为id小的一方
    ...
    /**
     * 故方法名思议，以receiver做为ClientB进行ack，ClientB即作为id大的一方
    ...
    void updateLatestOfflineReceiverClientA(String receiverID, String senderID, String fingerprint);
    ...
    void updateLatestOfflineReceiverClientB(String receiverID, String senderID, String fingerprint);
}